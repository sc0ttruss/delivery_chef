...
default['delivery_chef']['supermarket_server_fqdn'] = 'https://supermarket.myorg.chefdemo.net'
...
default['delivery_chef']['packages']['chef-server-core'] = 'chef-server-core-12.9.1-1.el7.x86_64.rpm'
default['delivery_chef']['packages']['manage'] = 'chef-manage-2.4.3-1.el7.x86_64.rpm'
default['delivery_chef']['packages']['reporting'] = 'opscode-reporting-1.6.4-1.el7.x86_64.rpm'
